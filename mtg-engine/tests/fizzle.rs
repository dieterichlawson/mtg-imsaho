...
fn swords_fizzle_no_side_effects() {
    ...
    state = engine::submit_action(
        &state,
        &Action::CastSpell { object_id: swords, targets: vec![Target::Object(creature)], sacrifice: None, exile_count: None, exile_ids: vec![], alternative_cost: None },
        &reg,
    );
...
fn flashback_spell_fizzle_goes_to_exile() {
    ...
    state = engine::submit_action(
        &state,
        &Action::CastSpell { object_id: geistflame, targets: vec![Target::Object(creature)], sacrifice: None, exile_count: None, exile_ids: vec![], alternative_cost: None },
        &reg,
    );
...
fn no_target_spell_always_resolves() {
    ...
    state = engine::submit_action(
        &state,
        &Action::CastSpell { object_id: div, targets: vec![], sacrifice: None, exile_count: None, exile_ids: vec![], alternative_cost: None },
        &reg,
    );
    state.events.clear();
