...
impl CardBehavior for UnrulyMob {
    ...
    fn on_any_creature_dies(&self, state: &mut GameState, self_id: ObjectId, _dead_id: ObjectId, dead_controller: PlayerId, _dead_damaged_by: &[ObjectId], _registry: &CardRegistry) {
