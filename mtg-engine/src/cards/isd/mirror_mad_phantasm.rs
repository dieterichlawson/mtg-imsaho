...
impl CardBehavior for MirrorMadPhantasm {
    fn card_data(&self) -> CardData {
        CardData {
            ...
            power: Some(5),
            toughness: Some(1),
            oracle_text: "Flying\n{1}{U}: Mirror-Mad Phantasm's owner shuffles it into their library. If that player does, they reveal cards from the top of their library until they reveal a card named Mirror-Mad Phantasm, put that card onto the battlefield, and put all other cards revealed this way into their graveyard.".into(),
