...
impl CardBehavior for LudevicsTestSubject {
    fn card_data(&self) -> CardData {
        CardData {
            ...
            power: Some(0),
            toughness: Some(3),
            oracle_text: "{1}{U}: Put a hatchling counter on Ludevic's Test Subject. Then if there are five or more hatchling counters on it, remove all of them and transform Ludevic's Test Subject.".into(),
            keywords: vec![],
            flashback_cost: None,
