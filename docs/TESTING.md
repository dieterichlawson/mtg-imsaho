...
| the fuzzing oracle checks itself | `invariant_checker.rs`, `invariant_families.rs`, `invariant_event_window.rs`, `invariant_legal_offers.rs`, `invariant_prompt_shapes.rs` |
