...
PAIRS = [("vampire_h2","bust_vampire"),("zombie_h2","bust_ghoul"),
         ("soldier_h2","bust_inquisitor")]
def img(name, scale):
...
d.text((20, 12), "FULL FIGURE  →  BUST", font=fb, fill=(0xf2,0xea,0xd9))
d.text((240, 14), "crop to head and shoulders, let the rest go black, spend every pixel on the face",
...
out.save('out/bust.png'); print('out/bust.png', out.size)
