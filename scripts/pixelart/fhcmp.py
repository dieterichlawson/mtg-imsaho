...
PAIRS = [("soldier","soldier_h"),("zombie","zombie_h"),
         ("vampire","vampire_h"),("scholar","scholar_h")]
def img(name, scale):
...
d.text((20, 12), "BEFORE  →  HORROR PASS", font=fb, fill=(0xf2,0xea,0xd9))
d.text((240, 14), "near-black body · light only on the lit edge · face is a void · one accent",
...
out.save('out/horror.png'); print('out/horror.png', out.size)
