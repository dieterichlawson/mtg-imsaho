...
PAIRS = [("bust_vampire","bust_vampire2"),("bust_ghoul","bust_ghoul2"),
         ("bust_inquisitor","bust_inquisitor2")]
def img(name, scale):
...
d.text((20, 12), "LIT OUTLINE  →  LIT MASS", font=fb, fill=(0xf2,0xea,0xd9))
d.text((240, 14), "the flesh is the bright mass; the features are the holes; no keyline on the silhouette at all",
...
out.save('out/mass.png'); print('out/mass.png', out.size)
