...
**Scryfall Oracle text**: {T}: Add {C}. / {2}{G}{W}, {T}: Put a +1/+1 counter on each creature you control.
**Scryfall type line**: Land
**Status**: PASS

No issues found. Card data, mana abilities, and activated ability all match Oracle text. Tests exist (tier10_cards.rs).
