...
1. **LLM card knowledge inaccurate**: The LLM entry says "Counter target spell. Its controller discards a card." but Oracle says "Counter target spell unless its controller pays {1}." The "unless pays {1}" clause is missing, making the LLM think this is a hard counter when it's actually a soft counter. File: `mtg-player/src/llm.rs`, line 73.
