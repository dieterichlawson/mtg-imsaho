...
**Scryfall Oracle text**: {T}: Add {C}. {W}{U}, {T}, Exile a creature card from your graveyard: Create a 1/1 white Spirit creature token with flying.
**Scryfall type line**: Land
**Status**: ISSUE

1. The creature card to exile from graveyard is auto-selected (first found) rather than presenting a choice to the player. The Oracle text says "Exile a creature card" which should allow the player to choose which creature card to exile. (File: /home/user/mtg-imsaho/mtg-engine/src/cards/moorland_haunt.rs, lines 84-89)
