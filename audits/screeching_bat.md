...
**Colour source**: external, fetched this session — a web search over the Scryfall and mtg.wtf results returned that "Stalking Vampire has a color indicator of black". Not from memory.
**Status**: ISSUE (fixed)
...
- Fixed: `color_indicator: vec![Color::Black]` on the back face (Stalking Vampire is black).
