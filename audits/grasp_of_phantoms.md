...
**Scryfall Oracle text**: Put target creature on top of its owner's library. / Flashback {7}{U}
**Scryfall type line**: Sorcery
**Status**: PASS

No issues found. Mana cost {3}{U} correct. Flashback {7}{U} correct. Correctly puts target creature on top of owner's library. Uses move_spell_after_resolve. Tests exist (tier11_cards.rs).
